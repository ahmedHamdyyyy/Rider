            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text("معلومات السائق", style: boldTextStyle()),
                    InkWell(
                      onTap: () {
                      ...
                      children: [
                        ...
                        Text(
                            widget.userData!.firstName != null
                                ? widget.userData!.firstName.validate()
                                : "",
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("موديل السيارة", style: primaryTextStyle(size: 14)),
                    Text(
                        widget.userData!.userDetail!.carModel != null
                            ? widget.userData!.userDetail!.carModel!.validate()
                            : "",
                        style: secondaryTextStyle()),
                  ],
                ),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("رقم اللوحة", style: primaryTextStyle(size: 14)),
                    Text(
                        widget.userData!.userDetail!.carPlateNumber != null
                            ? widget.userData!.userDetail!.carPlateNumber!
                                .validate()
                            : "",
                        style: secondaryTextStyle()),
                  ],
